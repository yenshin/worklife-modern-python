...
def upgrade():
    ...
    sa.Column('vacation_type', postgresql.ENUM('UnpaidLeave', 'PaidLeave', name='vacationtype'), nullable=False),
    ...
    op.create_index(op.f('ix_vacation_end_date'), 'vacation', ['end_date'], unique=False)
    op.create_index(op.f('ix_vacation_id'), 'vacation', ['id'], unique=False)
    op.create_index(op.f('ix_vacation_start_date'), 'vacation', ['start_date'], unique=False)
    op.create_index(op.f('ix_vacation_user_id'), 'vacation', ['user_id'], unique=False)
    op.create_index(op.f('ix_vacation_vacation_type'), 'vacation', ['vacation_type'], unique=False)
